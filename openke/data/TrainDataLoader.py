...
class TrainDataLoader(object):
    def __init__(self):
        ...
        self.in_path = Config.data_path
        self.tri_file = Config.tri_file
        self.ent_file = Config.ent_file
        self.rel_file = Config.rel_file
        if self.in_path is not None:
            self.tri_file = os.path.join(self.in_path, 'train2id.txt')
        ...
        self.nbatches = Config.n_batches
        self.batch_size = Config.batch_size
        self.bern = Config.bern_flag
        self.filter = Config.filter_flag
        self.negative_ent = Config.neg_ent
        self.negative_rel = Config.neg_rel
        self.sampling_mode = Config.train_sampling_mode
